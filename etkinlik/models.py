...
class Ticket(models.Model):
    ...
    qr_code = models.CharField(max_length=255, unique=True)  # Her bilet için benzersiz QR kod verisi
    ...
    def __str__(self):
        return f"{self.name} - {self.email} - {self.student_id} - {self.department}"